...
module Core
    ...
    def overlap?(a, b)
        return true if a.x_pos + 1 >= b.x_pos && a.x_pos + 1 <= b.x_pos + b.width && a.y_pos >= b.y_pos && a.y_pos + 1 <= b.y_pos + b.height
        return true if b.x_pos + 1 >= a.x_pos && b.x_pos + 1 <= a.x_pos + a.width && b.y_pos >= a.y_pos && b.y_pos + 1 <= a.y_pos + a.height
        false
    end
